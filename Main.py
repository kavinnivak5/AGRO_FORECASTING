...
def Home():
	...
	message1 = tk.Label(window, text="CROP PREDICTION" ,bg=bgcolor  ,fg=fgcolor  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
	...
	lbl6 = tk.Label(window, text="SVM RESULT",width=20  ,height=2  ,fg=fgcolor  ,bg=bgcolor ,font=('times', 15, ' bold ') ) 
	...
	def KNNprocess():
		knn.process("results/data2.csv")
		tm.showinfo("Input", "KNN Successfully Finished")
	def RFprocess():
		rf.process("results/data2.csv")
	...
	trainbutton = tk.Button(window, text="SVM", command=Svmprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
	trainbutton.place(x=210, y=600)
	...
	DCbutton.place(x=310, y=600)
	trainbutton1 = tk.Button(window, text="KNN", command=KNNprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
	trainbutton1.place(x=510, y=600)


	DCbutton2 = tk.Button(window, text="RF", command=RFprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
	DCbutton2.place(x=610, y=600)

	DCbutton1 = tk.Button(window, text="Prediction", command=Predictprocess  ,fg=fgcolor   ,bg=bgcolor1   ,width=10  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
	DCbutton1.place(x=710, y=600)
